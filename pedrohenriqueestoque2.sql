...
--
-- Banco de dados: `pedrohenriqueestoque`
--
CREATE DATABASE IF NOT EXISTS `pedrohenriqueestoque` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `pedrohenriqueestoque`;
...
CREATE TABLE `vendedor` (
  ...
  `sal_fix` decimal(15,2) DEFAULT NULL,
...
INSERT INTO `vendedor` (`cod_vendedor`, `nome_vendedor`, `sal_fix`, `faixa_comissao`) VALUES
(11, 'João', 2780.00, 'C'),
(101, 'João', 2650.32, 'C'),
