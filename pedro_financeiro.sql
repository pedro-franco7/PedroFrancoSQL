...
--
-- Banco de dados: `pedro_financeiro`
--
CREATE DATABASE IF NOT EXISTS `pedro_financeiro` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `pedro_financeiro`;
...
ELSE
SELECT 'sO novos NOME e CPF devem ser informados!'
AS Msg;
END IF;
END$$
...
(1, 'Pedro Henrique Franco dos Santos', '023.456.789-10'),
